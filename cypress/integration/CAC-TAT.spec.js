...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('exibe mensagem de erro so submeter o formulário com um email com formatação inválida', function() {
        cy.get('#firstName').type('Patricia')
        cy.get('#lastName').type('Siqueira')
        cy.get('#email').type('patriciafs1@gmail,com')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        cy.get('#firstName')
         ...
         cy.get('#lastName')
            ...
            .should('have.value','') 
        cy.get('#email')
            .type('patriciafs1@gmail.com')
            .should('have.value','patriciafs1@gmail.com')  
            .clear()   
            .should('have.value','') 
        cy.get('#phone')
            .type('1234567890')
